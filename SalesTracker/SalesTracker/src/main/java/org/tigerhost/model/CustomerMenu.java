        ...
        switch (subMenuSelector) {
            ...
            case 1 -> {
                try {
                    ...
                    Customer newCustomer = new Customer(cus_number, cus_first_name, cus_last_name, cus_phone_number, cus_email, cus_current_balance, sales_rep_id);
